(function($) {
	...
	$.keyboard.plugins.monitor	= function(e) {
    // console.log("keyboard ui", $('.keyboard'));
    
    $('.keyboard-key').each(function(e, i) {
    ...
    var updateGui = function() {
      ...
      $('.keyboard-key').each(function(e, i) {
        if (_.include(keys, $(this).data('key'))) {
    ...
    setInterval(function(){
     ...
     updateGui();
         ...
         // }
              // $(keyEl.data(pluginName+'-key'
         // $(exampleElement).val(keysString);
        }, 250);
